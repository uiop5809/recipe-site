...
const AppStateProvider = ({ children }) => {
  ...
  const [recipe] = useState([
    {
      ...
      desc: "닭볶음탕 또는 닭도리탕은 형태상 조림에 가까운 한국의 요리이다. 토막 낸 닭고기를 고추장, 고춧가루, 간장, 파, 마늘 등의 양념으로 볶거나 약간의 국물을 남기고 졸여 만든다. 부재료로는 주로 큼직하게 썬 감자, 양파, 당근 등이 같이 들어간다. 20세기 초에 평양 등 관서 지방에서부터 유래된 것으로 추정되고 있는데, 이름을 놓고 논란이 많은 음식이다. 일각에서는 닭볶음탕이나 닭도리탕 대신 '닭감자탕', '닭매운탕', '닭감자조림' 등으로도 부르고 있다.",
      coverImg:
    ...
    },
    {
      ...
      coverImg:
        "https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTA5MDhfNjkg%2FMDAxNjMxMDkyMjY4NDYz.iOLbPaexdSB3xX9d10WoBzS-QTH6tmBA8GuOOOJuG34g.K8tEeFF1GynjCTwwHm8heoBhKXJVXcmINiG0G6MB4FYg.JPEG.fer386%2FIMG_6826.jpg&type=l340_165",
      totalTime: 20,
      ingredients: [
        "신김치 1국그릇",
        "참치 1캔",
    ...
    },
    {
      ...
      coverImg:
        "https://ww.namu.la/s/7411e2449fef90e0444938105f9974aa27017e2af6d85ce54e814bd708c12b8efd3568c68684b98c44163107d758396349a0a423d9bd7ac40d66ab3fc7c2827592211105b88852a76d78b06fd62be19d36501a16cb7c19b89d7e9adc6668a62f",
      totalTime: 30,
      ingredients: [
        "무 한토막",
        "쪽파",
    ...
    },
    {
      ...
      coverImg:
        "https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMjA0MDFfMTEz%2FMDAxNjQ4Nzg4MDg2NTkz.aspy1hDVxAEx-fNj2mmnNcLvMTze22FGGLoKISpxA2cg.xW8Se3S31tyzXulO-dVEIoEoTpLId28rlyV36JbAJDog.JPEG.snazzyjin%2Foutput_1962539365.jpg&type=a340",
      ingredients: [
        "돼지고기 400g",
        "양파 중 2개",
        "양배추 1/4개",
    ...
    },
    {
      ...
      coverImg:
        "https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMjA0MDRfNTEg%2FMDAxNjQ5MDU0NTY4NjQz.509tLcq8OE9r_S1KYhx9LV158ZjVagXpkEXde8Y0TBEg.sYTDFgqfVHp_DDLq8DFlM9g-wNchW5uHwo3jfOcj5Wwg.JPEG.minyyp%2F20220404_112707.jpg&type=a340",
      ingredients: [
        "면 2인분",
        "오징어 50g",
        "냉동 칵테일새우 12마리",
    ...
    },
    {
      ...
      coverImg:
        "https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMjAzMjBfODQg%2FMDAxNjQ3NzYzMDQzNTUw.1JHNBd9eQPsuhsP4oW2yR4E7li4Ef0pGfOb34RmCWUYg.iB_D4xw6ekZu6uMCaAzBzvsPNFD6qjNYwznpFAv86mkg.JPEG.shimsoun0317%2FIMG_6274.jpg&type=a340",
      ingredients: [
        "돼지고기안심 300g",
        "소금 약간",
        "후추 약간",
    ...
    },
    {
      ...
      coverImg:
        "https://dbscthumb-phinf.pstatic.net/2888_000_1/20150129111818854_0DC1BUDTA.jpg/fb39_80_i1.jpg?type=w575_fst&wm=N",
      ingredients: [
        "파스타면 1줌",
        "베이컨",
        "토마토소스(폰타나) 1/2통",
  ...
  return (
    // 상태를 가지고 있는 객체
    <AppStateContext.provider value={{ recipe }}>
      {children}
